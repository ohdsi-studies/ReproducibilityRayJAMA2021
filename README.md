...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
    ...
    ```r
    library(ReproducibilityRayJAMA2021)
    ...
    outputFolder <- "c:/ReproducibilityRayJAMA2021"
...
License
=======
The ReproducibilityRayJAMA2021 package is licensed under Apache License 2.0

Development
===========
ReproducibilityRayJAMA2021 was developed in ATLAS and R Studio.
